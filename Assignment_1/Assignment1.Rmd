...
## Count the number of mapped reads - 1 pt

## Count the number of unmapped reads - 1 pt
...
Follow tutorial from: *https://happygitwithr.com/index.html*
...
You can get up to 20 points, if you answer all the questions correctly. Make sure to consult the resources given through the assignment, they are meant to make the assignment easier. 
  ...
  - Getting Familiar - 7 pt
  - Managing Conda Environments - 3
